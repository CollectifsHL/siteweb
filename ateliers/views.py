...
from marcheLibre.models import Suivis, Profil
...
def contacterParticipantsAtelier(request, slug):
    ...
    if form.is_valid():
        sujet = "[CollectifsHL] Au sujet de l'atelier CollectifsHL '" + atelier.titre +"'"
        ...
        try:
            ...
            if form.cleaned_data['renvoi']:
                send_mail(sujet,
                          "Vous avez envoyé aux participants de l'atelier CollectifsHL '" + atelier.titre +"' le message suivant : " + message_html,

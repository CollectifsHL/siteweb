...
urlpatterns = [
    ...
    url(r'^collectifshs/admin/$', views.admin_asso, name='admin_asso'),
    url(r'^RTG/admin/$', views.admin_asso_rtg, name='admin_asso_rtg'),
    url(r'^collectifshs/fichiers/$', views.telechargements_asso, name='telechargements_asso'),
    url(r'^collectifshs/adhesion_asso/$', views.adhesion_asso, name='adhesion_asso'),
    ...
    url(r'^collectifshs/presentation/$', views.presentation_asso, name='presentation_asso'),
    url(r'^site/presentation/$', views.presentation_site, name='presentation_site'),
    url(r'^collectifshs/statuts/$', views.statuts, name='statuts'),

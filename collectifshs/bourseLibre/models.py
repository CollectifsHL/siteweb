...
class Produit(models.Model):  # , BaseProduct):
    ...
    estPublique = models.BooleanField(default=False, verbose_name='Publique (cochez) ou Interne (décochez) [réservé aux membres collectifshs]')
...
class MessageGeneralPermacat(models.Model):
    ...
    @property
    def get_edit_url(self):
        return reverse('modifierMessage',  kwargs={'id':self.id, 'type':'collectifshs'})

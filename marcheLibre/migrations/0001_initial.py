...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='item',
            name='panier',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marcheLibre.Panier', verbose_name='panier'),
        ),
        migrations.AddField(
            model_name='item',
            name='produit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marcheLibre.Produit'),
        ),
        migrations.AddField(
            model_name='profil',
            name='adresse',

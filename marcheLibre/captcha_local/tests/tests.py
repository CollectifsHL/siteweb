...
from marcheLibre.captcha_local.conf import settings
from marcheLibre.captcha_local.fields import CaptchaField, CaptchaTextInput
from marcheLibre.captcha_local.models import CaptchaStore
import django
...
class CaptchaCase(TestCase):
    ...
    def test_get_version(self):
        from marcheLibre import captcha_local
        captcha_local.get_version(True)

# -*- coding: utf-8 -*-
"""
Django settings for marcheLibre project.
...
MIDDLEWARE = [
    ...
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
     ...
     'marcheLibre.middleware.CheckRequest',
    #"visits.middleware.BotVisitorMiddleware",
     #"visits.middleware.CounterMiddleware",
   # 'marcheLibre.middleware.SetLastVisitMiddleware'
    #'django.core.context_processors.request',
    #'debug_toolbar.middleware.DebugToolbarMiddleware',
]


ROOT_URLCONF = 'marcheLibre.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {'is_numeric': 'marcheLibre.templatetags.app_filters', }
        },
    },
]


WSGI_APPLICATION = 'marcheLibre.wsgi.application'
# Database
if LOCALL:
    DATABASES = {
       'default': {
...
AUTH_USER_MODEL = 'marcheLibre.Profil'
...
#     "VAPID_ADMIN_EMAIL": "sitecollectifshl@gmail.com"
# }

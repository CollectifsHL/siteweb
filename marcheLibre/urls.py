...
from marcheLibre.views import handler400 as h400, handler403  as h403, handler404  as h404, handler500  as h500
...
admin.sites.site_title ="Admin CollectifsHL"


urlpatterns = [
    url(r'^tinymce/', include('tinymce.urls')),
    url(r'^summernote/', include('django_summernote.urls')),
    url(r'^captcha/', include('marcheLibre.captcha_local.urls')),
    ...
    url(r'^forum/', include('blog.urls', namespace='marcheLibre.blog')),
#    url(r'^jardins/', include('jardinpartage.urls', namespace='marcheLibre.jardinpartage')),
    url(r'^vote/', include('vote.urls', namespace='marcheLibre.vote')),
    url(r'^kit/', include('fiches.urls', namespace='marcheLibre.fiches')),
    url(r'^ateliers/', include('ateliers.urls', namespace='marcheLibre.ateliers')),
    ...
    url(r'^marcheLibre/lister_offres/', login_required(views.ListeProduit_offres.as_view()),
        name="marche_offres"),
    url(r'^marcheLibre/lister_recherches/', login_required(views.ListeProduit_recherches.as_view()),
        name="marche_recherches"),

    url(r'^marcheLibre/detail/(?P<produit_id>[0-9]+)/$', login_required(views.detailProduit), name='produit_detail',),

    url(r'^marcheLibre/modifier/(?P<pk>[0-9]+)/$',
        login_required(views.ProduitModifier.as_view()), name='produit_modifier', ),
    url(r'^marcheLibre/contacterProducteur/(?P<producteur_id>[0-9]+)/$',
        login_required(views.produitContacterProducteur), name='produit_contacterProducteur', ),
    url(r'^marcheLibre/supprimer/(?P<pk>[0-9]+)/$',
...
urlpatterns += [
    url(r'^robots\.txt$', TemplateView.as_view(template_name="marcheLibre/robots.txt", content_type='text/plain')),
]
